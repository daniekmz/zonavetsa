      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1">
          <div className="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm text-center">
            ...
            <h3 className="font-bold text-lg text-slate-800 dark:text-slate-100">{teacher.name}</h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm">{teacher.subject || "Guru"}</p>
